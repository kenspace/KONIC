...
angular.module("konic",["ionic","konic.controllers","konic.services","konic.directives"]).config(["$stateProvider","$urlRouterProvider","$ionicConfigProvider","$httpProvider",function(e,t,r,o){r.tabs.position("bottom"),r.tabs.style("standard"),r.views.swipeBackEnabled(!1),o.defaults.headers.post["Content-Type"]="application/x-www-form-urlencoded;charset=utf-8",o.defaults.headers.put["Content-Type"]="application/x-www-form-urlencoded;charset=utf-8";var n=function(e){var t,r,o,c,i,s,l,a="";for(t in e)if(r=e[t],r instanceof Array)for(l=0;l<r.length;++l)i=r[l],o=t+"["+l+"]",s={},s[o]=i,a+=n(s)+"&";else if(r instanceof Object)for(c in r)i=r[c],o=t+"["+c+"]",s={},s[o]=i,a+=n(s)+"&";else void 0!==r&&null!==r&&(a+=encodeURIComponent(t)+"="+encodeURIComponent(r)+"&");return a.length?a.substr(0,a.length-1):a};o.defaults.transformRequest=[function(e){return angular.isObject(e)&&"[object File]"!==String(e)?n(e):e}],e.state("tab",{url:"/tab","abstract":!0,templateUrl:"templates/tabs.html"}).state("tab.index",{url:"/index",views:{"tab-index":{templateUrl:"templates/index.html",controller:"IndexCtrl"}}}).state("tab.directives",{url:"/directives",views:{"tab-directives":{templateUrl:"templates/directives.html",controller:"DirectivesCtrl"}}}).state("tab.ionic",{url:"/ionic-directives",views:{"tab-directives":{templateUrl:"templates/directives/ionic.html",controller:"IonicDirectivesCtrl"}}}).state("tab.ionic-content",{url:"/ionic-content",views:{"tab-directives":{templateUrl:"templates/directives/ionic/content.html",controller:"IonicContentCtrl"}}}).state("tab.contact",{url:"/contact",views:{"tab-contact":{templateUrl:"templates/contact.html",controller:"ContactCtrl"}}}),t.otherwise("/tab/index")}]);var controllers=angular.module("konic.controllers",[]),directives=angular.module("konic.directives",[]),services=angular.module("konic.services",[]),KONIC={config:{},setConfig:function(e){"use strict";switch(e){case"local":return void(this.config={type:"local",URL:"http://localhost",debug:!0,alert:!1});case"pro":return void(this.config={type:"pro",URL:"http://localhost",debug:!1,alert:!1})}},debug:function(e,t){"use strict";var r=t?t:"SYSTEM";this.config.alert===!0?alert("System time : "+this.getTime()+"\nMethod name : "+r+"\n"+JSON.stringify(e)):this.config.debug===!0&&(console.log("System time : "+this.getTime()+"\nMethod name : "+r),console.log(e),console.log("#######################################"),console.log(""))},getTime:function(e,t){"use strict";var r=new Date,o=new Date;t&&o.setDate(o.getDate()+t);var n=t?o:r,c=(n.getFullYear(),n.getMonth()+1>9?n.getMonth()+1:"0"+(n.getMonth()+1),n.getDate()>9?n.getDate():"0"+n.getDate(),n.getHours()>9?n.getHours():"0"+n.getHours()),i=n.getMinutes()>9?n.getMinutes():"0"+n.getMinutes(),s=n.getSeconds()>9?n.getSeconds():"0"+n.getSeconds(),l=n.getMilliseconds();switch(e){default:return c+":"+i+":"+s+":"+l}}};KONIC.setConfig("local"),controllers.controller("MainCtrl",["$rootScope","$state","$ionicViewSwitcher",function(e,t,r){e.screenWidth=document.documentElement.clientWidth,e.screenHeight=document.documentElement.clientHeight,e.cloneObj=function(e){var t=e.constructor===Object?{}:[];if("object"==typeof JSON){var r=JSON.stringify(e);t=JSON.parse(r)}else if(t.constructor===Array)t.concat(e);else for(var o in e)t[o]=e[o];return t},e.goURL=function(o,n,c){if("tab.index"!==o&&(e.hiddenTopBar=!1),c)switch(c){case"forward":r.nextDirection("forward");break;case"back":r.nextDirection("back")}t.go(o,n)}}]).controller("IndexCtrl",["$scope","Postman",function(e,t){e.rep={},e.ajax=function(r){var o;"get"===r?(o=t.httpGetUrl("http://127.0.0.1:3000",{key:"konic"}),o.then(function(t){e.rep.get=JSON.stringify(t)},function(e){})):"post"===r&&(o=t.httpPostUrl("http://127.0.0.1:3000",{key:"konic"}),o.then(function(t){e.rep.post=JSON.stringify(t)},function(e){}))}}]).controller("DirectivesCtrl",["$scope",function(e){}]).controller("IonicDirectivesCtrl",["$scope",function(e){}]).controller("IonicContentCtrl",["$scope","$ionicScrollDelegate","$ionicPopup","$timeout",function(e,t,r,o){e.doRefresh=function(){r.alert({title:"操作提示",template:"下拉松开后所执行函数"}),o(function(){e.$broadcast("scroll.refreshComplete")},1e3)},e.loadMoreData=function(){r.alert({title:"操作提示",template:"上拉到底部松开后所执行函数，本例子是执行滚动到内容顶部函数"}),o(function(){t.scrollTop(),e.$broadcast("scroll.infiniteScrollComplete")},1e3)}}]).controller("ContactCtrl",["$scope",function(e){e.settings={enableFriends:!0}}]),directives.directive("historyBack",["$window",function(e){return{restrict:"EA",replace:!1,transclude:!0,scope:!0,template:'<ion-item ng-click="goBack()" class="nav-bar-button"><i class="ion-chevron-left"></i></ion-item>',link:function(t){t.goBack=function(){e.history.back()}}}}]),services.factory("Postman",["$http","$q",function(e,t){return{httpGet:function(r,o){var n=t.defer();return e.get(KONIC.config.URL+r,{params:o}).success(function(e){KONIC.debug(e,r+" Success"),n.resolve(e)}).error(function(e){KONIC.debug(e,r+" Error"),n.reject(e)}),n.promise},httpGetUrl:function(r,o){var n=t.defer();return e.get(r,{params:o}).success(function(e){KONIC.debug(e,r+" Success"),n.resolve(e)}).error(function(e){KONIC.debug(e,r+" Error"),n.reject(e)}),n.promise},httpPost:function(r,o,n){var c=t.defer();return e.post(KONIC.config.URL+r,o,{headers:n}).success(function(e){KONIC.debug(e,r+" Success"),c.resolve(e)}).error(function(e){KONIC.debug(e,r+" Error"),c.reject(e)}),c.promise},httpPostUrl:function(r,o,n){var c=t.defer();return e.post(r,o,{headers:n}).success(function(e){KONIC.debug(e,r+" Success"),c.resolve(e)}).error(function(e){KONIC.debug(e,r+" Error"),c.reject(e)}),c.promise},httpPut:function(r,o){var n=t.defer();return e.put(KONIC.config.URL+r,o).success(function(e){KONIC.debug(e,r+" Success"),n.resolve(e)}).error(function(e){KONIC.debug(e,r+" Error"),n.reject(e)}),n.promise},httpDelete:function(r,o){var n=t.defer();return e["delete"](KONIC.config.URL+r,{params:o}).success(function(e){KONIC.debug(e,r+" Success"),n.resolve(e)}).error(function(e){KONIC.debug(e,r+" Error"),n.reject(e)}),n.promise}}}]);